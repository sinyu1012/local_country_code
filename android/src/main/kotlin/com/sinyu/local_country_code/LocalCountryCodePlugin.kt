package com.sinyu.local_country_code
...
/** LocalCountryCodePlugin */
class LocalCountryCodePlugin : FlutterPlugin, MethodCallHandler {
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, "local_country_code")
